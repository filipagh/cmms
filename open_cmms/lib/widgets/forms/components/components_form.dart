...
//
//
// class StationComponentsForm extends StatelessWidget implements hasFormTitle {
//
//   final schema.StationSchema station;
//
//   StationComponentsForm.editComponentsInStation({Key? key, required this.station})
//       : super(key: key);
//
//
//   String getTitle() {
...
//   List<schema.AssignedComponentSchema> actualComponents = [];
...
//               onPressed: () {
//                 showFormDialog<Item>(
//                         AddComponentForm_dummy(editItem: station))
//                     .then((value) {
