...
class RedmineObjectSchema {
  /// Returns a new [RedmineObjectSchema] instance.
  RedmineObjectSchema({
    required this.id,
    required this.name,
  });
  ...
  static RedmineObjectSchema? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<RedmineObjectSchema>? listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RedmineObjectSchema.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RedmineObjectSchema> mapFromJson(dynamic json) {
    final map = <String, RedmineObjectSchema>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RedmineObjectSchema.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
