...
class AssetTelemetryType {
  ...
  static const DEW_POINT_TEMPERATURE = AssetTelemetryType._(r'DEW_POINT_TEMPERATURE');
  ...
  AssetTelemetryType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'DEW_POINT_TEMPERATURE': return AssetTelemetryType.DEW_POINT_TEMPERATURE;
