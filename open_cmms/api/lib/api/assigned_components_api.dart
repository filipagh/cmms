...
class AssignedComponentsApi {
  ...
  Future<Response> createInstalledComponentAssignedComponentsCreateInstalledComponentPostWithHttpInfo(List<AssignedComponentNewSchema> assignedComponentNewSchema,) async {
