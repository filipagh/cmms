...
class TaskServiceOnSiteApi {
  ...
  Future<Response> createTaskServiceOnSiteCreateServiceOnSideTaskPostWithHttpInfo(TaskServiceOnSiteNewSchema taskServiceOnSiteNewSchema,) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [TaskServiceOnSiteNewSchema] taskServiceOnSiteNewSchema (required):
  Future<String?> createTaskServiceOnSiteCreateServiceOnSideTaskPost(TaskServiceOnSiteNewSchema taskServiceOnSiteNewSchema,) async {
    final response = await createTaskServiceOnSiteCreateServiceOnSideTaskPostWithHttpInfo(taskServiceOnSiteNewSchema,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
