...
------------------------------------------------------------------------------------------------------|-------------------------------------|----------------
 ...
 [**getAllStationStationsPublicGet**](StationApi.md#getallstationstationspublicget)                   | **GET** /station/stations_public    | Get All        
...
# **getAllStationStationsPublicGet**

> List<StationPublicSchema> getAllStationStationsPublicGet(roadSegmentId)
...
try {
final result = api_instance.getAllStationStationsPublicGet(roadSegmentId);
print(result);
} catch
(
e) {
print('Exception when calling StationApi->getAllStationStationsPublicGet: $e\n');
}
```
