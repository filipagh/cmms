...
def import_assets():
    ...
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=levoca),
        warranty_period_days=365 * 2, installation_date=datetime(2017, 11, 21))
    ...
    assigned_component_rest_router.create_installed_component(
        ...
        warranty_period_days=365 * 2, installation_date=datetime(2015, 11, 18))
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            asset_ids=[_InstallAsset(drs511bb5, "P06476"),
                       ],
            station_id=sibenik_zp),
        warranty_period_days=365 * 2, installation_date=datetime(2018, 6, 21))
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            asset_ids=[_InstallAsset(pwd12, "N4040536")
                       ],
            station_id=sibenik_zp),
        warranty_period_days=365 * 2, installation_date=datetime(2017, 10, 26))
    ...
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=sibenik_vp),
        warranty_period_days=365 * 2, installation_date=datetime(2018, 6, 26))
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
    ...
    assigned_component_rest_router.create_installed_component(
        ...
        warranty_period_days=365 * 2, installation_date=datetime(2016, 10, 31))
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
    ...
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=dolany),
        warranty_period_days=365 * 2, installation_date=datetime(2017, 12, 12))
    ...
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=klckov),
        warranty_period_days=365 * 2, installation_date=datetime(2017, 12, 11))
    ...
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=nemesany),
        warranty_period_days=365 * 2, installation_date=datetime(2017, 12, 13))
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            asset_ids=[_InstallAsset(DRS511AB2, "T01370"),
                       ],
            station_id=nemesany),
        warranty_period_days=365 * 2, installation_date=datetime(2021, 5, 15))
    ...
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=jablonov),
        warranty_period_days=365 * 4, installation_date=datetime(2022, 9, 28))
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=jablonov),
        warranty_period_days=365 * 2, installation_date=datetime(2018, 12, 12))
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=jablonov),
        warranty_period_days=365 * 2, installation_date=datetime(2010, 6, 3))
    ...
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=jablonov),
        warranty_period_days=365 * 2, installation_date=datetime(2020, 11, 12))
    ...
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=studenec),
        warranty_period_days=365 * 2, installation_date=datetime(2018, 11, 19))
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            asset_ids=[
                _InstallAsset(DTS12G, ),
    ...
    assigned_component_rest_router.create_installed_component(
        ...
        warranty_period_days=365 * 4, installation_date=datetime(2014, 12, 19))
    ...
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=bijatovce),
        warranty_period_days=365 * 2, installation_date=datetime(2019, 11, 19))
    ...
    assigned_component_rest_router.create_installed_component(
        ...
        warranty_period_days=365 * 4, installation_date=datetime(2022, 12, 19))
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            asset_ids=[_InstallAsset(DRS511AB2, "N08311")
                       ],
            station_id=beharovce),
        warranty_period_days=365 * 2, installation_date=datetime(2017, 7, 18))
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            asset_ids=[
            ...
            station_id=beharovce),
        warranty_period_days=365 * 2, installation_date=datetime(2021, 5, 8))
    ...
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=beharovce),
        warranty_period_days=365 * 2, installation_date=datetime(2014, 12, 19))
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
    ...
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=korytne),
        warranty_period_days=365 * 4, installation_date=datetime(2022, 9, 20))
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            asset_ids=[_InstallAsset(DRS511BB10, "K03413")
                       ],
            station_id=korytne),
        warranty_period_days=365 * 2, installation_date=datetime(2014, 5, 6))
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            asset_ids=[
    ...
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=korytne),
        warranty_period_days=365 * 2, installation_date=datetime(2013, 1, 10))
    ...
    assigned_component_rest_router.create_installed_component(
        new_components=_get_selected_assets_to_install(
            ...
            station_id=branisko_zp),
        warranty_period_days=365 * 2, installation_date=datetime(2015, 10, 14))
    ...
    assigned_component_rest_router.create_installed_component(
        ...
        warranty_period_days=365 * 4, installation_date=datetime(2022, 9, 21))
