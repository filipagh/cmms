...
class EmailTemplateType(object):
    ...
    allowable_values = [BASE, WELCOME, FORGOT_PASSWORD]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """EmailTemplateType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EmailTemplateType):
            return False
